...
class Index extends Controller
{
    ...
    {      
		...
		$banners = Banner::all();	
		$articles = Content::where('menu_id',397)->first();	
		$contactus = Content::where('menu_id',396)->first();	
		...
		return view('frontend.home',compact('menus','banners','articles','services','whychoose','ourteam','partners','services','galleries','counters','protfolios','contactus'));
    }
